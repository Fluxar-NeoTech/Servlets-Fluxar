...
@WebServlet(name = "RenovacaoValidarSenhaServlet", value = "/RenovacaoValidarSenhaServlet")
public class RenovacaoValidarSenhaServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!continuar) {
            request.getRequestDispatcher("/pages/renovacao/senha.jsp")
                    .forward(request, response);
            return;
        }
...
//        Redirecionando usuário:
        request.getRequestDispatcher("/pages/renovacao/pagamento.jsp")
                .forward(request, response);
    }
}
