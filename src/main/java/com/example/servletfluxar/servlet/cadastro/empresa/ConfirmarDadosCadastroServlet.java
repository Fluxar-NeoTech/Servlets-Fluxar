...
@WebServlet(name = "ConfirmarDadosCadastroServlet", value = "/ConfirmarDadosCadastroServlet")
public class ConfirmarDadosCadastroServlet extends HttpServlet {
    @Override
...
//      Declarando variáveis:
        ...
        try{
            ...
            request.setAttribute("erro", "Selecione uma duração para a assinatura");
...
//                Enviando um email com o código de verificação para ele
            ...
            response.sendRedirect(request.getContextPath() + "/pages/cadastro/codigo.jsp");
        } catch (Exception e) {
            e.printStackTrace();
