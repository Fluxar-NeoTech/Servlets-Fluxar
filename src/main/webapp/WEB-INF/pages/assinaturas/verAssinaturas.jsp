...
<main>
    <p id="title"><%= tipoUsuario == "administrador" ? "Assinaturas" : "Assinatura"%>
    </p>
    <section id="topo">
    ...
    <table style="--cols: 8;">
        ...
        <tr>
            ...
            <td><%=assinatura.getIdEmpresa()%>
            </td>
            <td><%=FormatoOutput.data(assinatura.getDtInicio())%>
            </td>
            <td><%=FormatoOutput.data(assinatura.getDtFim())%>
            </td>
            <td><%=assinatura.getIdPlano()%>
            </td>
            <td><%=FormatoOutput.status(assinatura.getStatus())%>
            </td>
            ...
            <td>
                <div id="juntos">
                    ...
                    <a href="${pageContext.request.contextPath}/AlterarAssinaturaServlet?id=<%=assinatura.getId()%>">
