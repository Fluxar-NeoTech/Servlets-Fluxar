...
<main>
    ...
    <form id="form" action="${pageContext.request.contextPath}/RemoverAdminServlet" method="post">
        <table class="confirmarDelecao" style="border-radius: 20px">
            ...
            <tr>
                <td>Id</td>
                <td style="border-left: solid 1px"><%=administrador.getId()%>
                </td>
            </tr>
            <tr>
                <td>Nome</td>
                <td style="border-left: solid 1px"><%=FormatoOutput.nome(administrador.getNome(), administrador.getSobrenome())%>
                </td>
            </tr>
            <tr>
                <td>Email</td>
                <td style="border-left: solid 1px"><%=administrador.getEmail()%>
                </td>
            </tr>
            </tbody>
        </table>
