...
<main>
  ...
  <table style="--cols: 4;">
    ...
    <tbody>
      <%if (!administradores.isEmpty()){%>
        <%for(Administrador administrador: administradores){%>
          <tr>
            ...
            <td><%=FormatoOutput.nome(administrador.getNome(), administrador.getSobrenome())%></td>
            <td><%=administrador.getEmail()%></td>
              <td>
                <a href="${pageContext.request.contextPath}/AlterarAdminServlet?id=<%=administrador.getId()%>">
                ...
                <a href="${pageContext.request.contextPath}/RemoverAdminServlet?id=<%=administrador.getId()%>">
      ...
      <%} else {%>
        <tr>
          <td colspan="5">Nenhum administrador foi encontrado!</td>
        </tr>
      <%}%>
    </tbody>
  </table>
  ...
  <%if (tipoUsuario.equals("administrador")) {%>
    <section id="footer">
        <a id="add" href="${pageContext.request.contextPath}/AdicionarAdmin">Adicionar</a>
      <div id="pages">
