...
<main>
  ...
  <section id="topo">
    ...
    <a href="/ListarEmpresasServlet?pagina=1" id="ver">Ver todos</a>
  </section>
  ...
  <table>
    ...
    <%if (tipoUsuario.equals("administrador")){%>
      ...
      <%} else {%>
      <tr>
        <td colspan="6"><%=request.getAttribute("erroFiltro")%></td>
      </tr>
    <%} else {%>
      <tr>
        <td><%=empresaLogada.getId()%></td>
        <td><%=empresaLogada.getNome()%></td>
        <td><%=empresaLogada.getCnpj()%></td>
        <td><%=empresaLogada.getEmail()%></td>
        <td><%=empresaLogada.getDtCadastro()%></td>
        <td>
          <a>Editar</a>
        </td>
      </tr>
  ...
  <%if (tipoUsuario.equals("administrador")) {%>
    <section id="footer">
        <a id="add" href="${pageContext.request.contextPath}/AdicionarEmpresa">Adicionar</a>
      <div id="pages">
