...
<main>
    <p id="title"><%= tipoUsuario == "administrador" ? "Empresas" : "Empresa"%>
    </p>
    <section id="topo">

        <form action="ListarEmpresasServlet" id="filtro" method="get">
            <div class="input-select">
                ...
                <div class="options">
                    ...
                    <span data-value="minDtCadastro">Min. Dt. Cadastro</span>
                    <span data-value="maxDtCadastro">Max. Dt. Cadastro</span>
                </div>
            </div>
    ...
    <table style="--cols: 6;">
        ...
        <tr>
            ...
            <td><%=FormatoOutput.cnpj(empresa.getCnpj())%>
            </td>
            <td><%=empresa.getEmail()%>
            </td>
            <td><%=FormatoOutput.data(empresa.getDtCadastro())%>
            </td>
            <td>
                <div id="juntos">
    ...
    <%if (tipoUsuario.equals("administrador")) {%>
    <section id="footer">
        <a class="botaoSecundario" id="add"
           href="${pageContext.request.contextPath}/AdicionarEmpresaServlet">Adicionar</a>
        <div id="pages">
