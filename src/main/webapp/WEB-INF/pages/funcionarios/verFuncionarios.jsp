...
<main>
    ...
    <table style=<%=tipoUsuario.equals("administrador") ? "--cols:5;" : "--cols:6;"%>>
        ...
        <tr>
            <td><%=funcionario.getId()%>
            </td>
            <td><%=FormatoOutput.nome(funcionario.getNome(), funcionario.getSobrenome())%>
            </td>
            <td><%=funcionario.getCargo()%>
            </td>
            <td><%=funcionario.getEmail()%>
            </td>
            <td><%=funcionario.getIdSetor()%>
            </td>
            <%
                if (tipoUsuario.equals("empresa")) {
            %>
            <td>
                <div id="juntos">
                    <a href="${pageContext.request.contextPath}/AlterarFuncionarioUnidadeServlet?id=<%=funcionario.getId()%>">
                    ...
                    <a href="${pageContext.request.contextPath}/RemoverFuncionarioServlet?id=<%=funcionario.getId()%>">
    ...
    <section id="footer">
        <%if (tipoUsuario.equals("empresa")) {%>
        <a class="botaoSecundario" href="${pageContext.request.contextPath}/AdicionarFuncionarioUnidadeServlet">Adicionar</a>
        <%}%>
