...
<main>
    ...
    <form id="form" action="${pageContext.request.contextPath}/RemoverUnidadeServlet" method="post">
        <table class="confirmarDelecao" style="border-radius: 20px">
            ...
            <tr>
                <td>Id</td>
                <td style="border-left: solid 1px"><%=unidade.getId()%>
                </td>
            </tr>
            <tr>
                <td>Nome</td>
            ...
            <tr>
                <td>Cnpj</td>
                <td style="border-left: solid 1px"><%=FormatoOutput.cnpj(unidade.getCnpj())%>
                </td>
            </tr>
            <tr>
                <td>Email</td>
                <td style="border-left: solid 1px"><%=unidade.getEmail()%>
                </td>
            </tr>
            <tr>
                <td>CEP</td>
                <td style="border-left: solid 1px"><%=FormatoOutput.cep(unidade.getCep())%>
                </td>
            </tr>
            <tr>
                <td>Número</td>
                <td style="border-left: solid 1px"><%=unidade.getNumero()%>
                </td>
            </tr>
            <tr>
                <td>Nome empresa</td>
