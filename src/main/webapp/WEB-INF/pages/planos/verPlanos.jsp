...
<% Integer paginaObjeto = (Integer) request.getAttribute("pagina");
    int pagina = (paginaObjeto
            != null) ? paginaObjeto : 1;
    List<Plano> planos = (List<Plano>)
            request.getAttribute("planos");
    ...
    <div id="nome">
        ...
        ((Empresa) session.getAttribute("empresa")).getId() :
            ...
            <%= tipoUsuario == "empresa" ? ((Empresa)
                    session.getAttribute("empresa")).getNome() : ((Administrador)
                    session.getAttribute("administrador")).getNome() + " " +
                    ((Administrador)
...
<aside>
    ...
    <nav>
        <ul class="linksServlet">
            ...
            <li>
                <a
                        href="${pageContext.request.contextPath}/ListarAdminsServlet">
                    <div class="text">
                        Admins
                    </div>
                </a>
            ...
            <li>
                <a
                        href="${pageContext.request.contextPath}/ListarPlanosServlet">
            ...
            <li>
                <a
                        href="${pageContext.request.contextPath}/ListarAssinaturasServlet">
                    <div class="text">
            ...
            <li>
                <a
                        href="${pageContext.request.contextPath}/ListarEmpresasServlet">
                    <div class="text">
                        <%if (tipoUsuario == "administrador") {%>
                        Empresas
                        <%} else {%>
            ...
            <li>
                <a
                        href="${pageContext.request.contextPath}/ListarUnidadesServlet">
                    <div class="text">
                        Unidades
                    </div>
                </a>
            ...
            <li>
                <a
                        href="${pageContext.request.contextPath}/ListarSetoresServlet">
                    <div class="text">
                        Setores
                    </div>
                </a>
            ...
            <li>
                <a
                        href="${pageContext.request.contextPath}/ListarFuncionariosServlet">
                    <div class="text func">
                        Funcionarios
                    </div>
                </a>
    ...
    <div>
        <a class="botaoPrimario"
           href="${pageContext.request.contextPath}/SairServlet">Sair</a>
    </div>
</aside>
<main>
    <p id="title">Plano</p>
    <section id="topo">
        ...
        <form action="ListarPlanosServlet" id="filtro" method="get">
            <div class="input-select">
                ...
                <div class="options">
                    ...
                    <span data-value="duracao">Duração</span>
                    <span data-value="minPreco">Min. Preço</span>
                    <span data-value="maxPreco">Max. Preço</span>
                </div>
            </div>
    ...
    <table style=<%=tipoUsuario.equals("administrador") ? "--cols:5;"
        ...
        <tr>
            ...
            <td>
                <%=FormatoOutput.preco(plano.getPreco())%>
            </td>
            <td>
                <%=FormatoOutput.duracao(plano.getTempo())%>
            </td>
            <% if (tipoUsuario.equals("administrador")) { %>
            <td>
                <div id="juntos">
                    <a
                            href="${pageContext.request.contextPath}/AlterarPlanoServlet?id=<%=plano.getId()%>">
                        <svg class="alterar" viewBox="0 0 34 30"
                             fill="none"
    ...
    <%} else {%>
    <p style="color: white">Não há nenhum plano cadastrado</p>
    <%}%>

    <section id="footer">
        <%if (tipoUsuario.equals("administrador")) {%>
        <a class="botaoSecundario"
           href="${pageContext.request.contextPath}/AdicionarPlanoServlet">Adicionar</a>
        <%}%>

        <div id="pages">
            <a
                    href="${pageContext.request.contextPath}/ListarPlanosServlet?pagina=<%=pagina - 1%>">
