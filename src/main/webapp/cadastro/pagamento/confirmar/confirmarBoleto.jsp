<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%  int plano=(int) session.getAttribute("plano"); 
        ...
        if (duracaoString.equals("Anual")){ 
            ...
            texto = "Tem certeza que pagará "+valorString+" em um boleto para usufruir do plano "+planoString+" do Fluxar no período de um mês?";
        }
    %>
    <!DOCTYPE html>
    <html lang="en">
        ...
        <main>
            <article>
                ...
                <form action="../../../FormaPagamentoServlet" method="get">
                    <input name = "formaPagamento" type="text" value="boleto">
