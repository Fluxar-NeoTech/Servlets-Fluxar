...
<% int plano = (int) session.getAttribute("plano");
    ...
    if (plano % 2 == 0) {
        ...
        texto = "Tem certeza que pagará " + valorString + " no pix para usufruir do plano " + planoString + " do Fluxar no período de um ano?";
    } else {
        if (plano == 1) {
            planoString = "Essential";
        ...
        texto = "Tem certeza que pagará " + valorString + " no pix para usufruir do plano " + planoString + " do Fluxar no período de um mês?";
    }
%>
<!DOCTYPE html>
<html lang="en">
