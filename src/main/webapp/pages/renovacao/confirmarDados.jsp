...
<main>
    <article>
        <div>
            <a href="${pageContext.request.contextPath}/pages/renovacao/escolhaPlano.jsp" class="btn-voltar">← Voltar</a>
        ...
        <form action="${pageContext.request.contextPath}/RenovarConfirmarDadosServlet" method="get">
        ...
        <nav class="nav-login" id="analista">
            <ul>
                <li>Plano errado? <a href="${pageContext.request.contextPath}/pages/renovacao/escolhaPlano.jsp">Clique aqui!</a></li>
            </ul>
        </nav>
    </article>
</main>
