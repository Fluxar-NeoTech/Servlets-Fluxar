...
<main>
    <article id="container-plano">
        <div>
            <a href="${pageContext.request.contextPath}/pages/cadastro/inicioCadastro.jsp" class="btn-voltar">← Voltar</a>
            <h1 id="loginTitle" class="caixa__title">Selecione um plano</h1>
            <div class="caixa__sub">Selecione o plano que mais se adéqua as necessidades da sua empresa</div>
        </div>
        <form action="${pageContext.request.contextPath}/EscolhaPlanoServlet" method="get">
            <!-- Plano Essential -->
